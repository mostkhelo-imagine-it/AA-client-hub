...
<p class="muted">Works with any CSV or Excel (.xlsx) file — a CRM export, a spreadsheet, a course platform's contact list. Upload it, then match its columns to Client Hub's fields on the next screen before anything is saved.</p>
